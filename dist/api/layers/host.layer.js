...
var HostLayer = /** @class */ (function () {
    ...
    HostLayer.prototype.spin = function (text, status) {
        ...
        var fullText = "{session: " + this.session;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(urlCode !== result.urlCode)) return [3 /*break*/, 5];
                        urlCode = result.urlCode;
                        attempt++;
                        qr = '';
                        if (!(this.options.logQR || catchQR)) return [3 /*break*/, 4];
                    ...
                    case 4:
                        ...
                        _a.label = 5;
                    case 5: return [4 /*yield*/, sleep_1.sleep(500)];
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 1];
